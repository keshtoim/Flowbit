...
| 🔢 | Числовые цели — единица измерения (л, км, стр…) отображается в счётчике |
| ⏱ | Таймер — обратный отсчёт; привычка отмечается выполненной автоматически |
...
| Одна привычка | 2×2 | Эмодзи + счётчик + серия 🔥 + кнопка «+» без открытия приложения |

### Остальное
| | |
|---|---|
| 🔔 | Точные напоминания; кнопка «Выполнено ✓» прямо в уведомлении |
